...
@export var max_ammo: int = 32      # reserve ammo
@export var clip_size: int = 8      # magazine capacity
@export var fire_rate: float = 1.0
@export var weapon_name = "shotgun"
var recoil_offset: Vector2 = Vector2.ZERO   # x = vertical, y = horizontal
@export var hole_size: float = 1.3   # <-- NEW (affects voxel terrain)
...
@onready var animation_player: AnimationPlayer = %rotateshotgun
