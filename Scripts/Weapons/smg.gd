...
@export var max_ammo: int = 120      # reserve ammo
@export var clip_size: int = 30     # magazine capacity
@export var fire_rate: float = 0.07
@export var hole_size: float = 1.0   # <-- NEW (affects voxel terrain)
@export var weapon_name = "smg"
...
@onready var animation_player: AnimationPlayer = %rotatesmg
