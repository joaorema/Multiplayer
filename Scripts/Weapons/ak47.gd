...
@export var max_ammo: int = 90      # reserve ammo
@export var clip_size: int = 30      # magazine capacity
@export var fire_rate: float = 0.1
@export var hole_size: float = 2.0   # <-- NEW (affects voxel terrain)
@export var weapon_name = "ak_47"
...
@onready var animation_player: AnimationPlayer = %rotateak
